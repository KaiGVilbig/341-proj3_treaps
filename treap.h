...
public:
  ...
  //
  //perform preorder and copy
  void preorder(TreapNode* x);

  //postorder to delete
  void postorder();
  
  void heapOps(TreapNode* GP);
  TreapNode* revHeapOps(TreapNode* curr, data_t x);

  void propDel(TreapNode* x, TreapNode* y);
